...
EXPORT_API int32_t network_create_and_bind(int64_t *socket_handle, const char *address, uint16_t port);
EXPORT_API int32_t network_sendmsg(int64_t socket_handle, network_iov_t *iov, int32_t iov_len, network_address *address);
EXPORT_API int32_t network_recvmsg(int64_t socket_handle, network_iov_t *iov, int32_t iov_len, network_address *remote);
