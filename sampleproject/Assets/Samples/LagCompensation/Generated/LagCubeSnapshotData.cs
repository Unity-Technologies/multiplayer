...
public struct LagCubeSnapshotData : ISnapshotData<LagCubeSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref LagCubeSnapshotData baseline1, ref LagCubeSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref LagCubeSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref LagCubeSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref LagCubeSnapshotData target, float factor)
    {
